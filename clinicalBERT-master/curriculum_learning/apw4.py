...
import sys
sys.path.append("/home/yyc/anaconda3/envs/clinicalBERT/lib/python3.8/site-packages")
import umap
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", default="train_with_difficulty_0701_2_3days.csv", help="输出 CSV 文件路径")
