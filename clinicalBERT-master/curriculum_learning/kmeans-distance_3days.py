...
def run_apw_kmeans_bert(args):
    ...
    # 6.2 在每簇内挑最远 farthest_ratio 的样本，合并成 hard
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_file", default="train_with_difficulty_kmeans+distance_3days.csv", help="输出 CSV 文件路径")
