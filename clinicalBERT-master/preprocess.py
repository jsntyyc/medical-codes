...
import os
os.makedirs('./discharge', exist_ok=True)
os.makedirs('./3days', exist_ok=True)
os.makedirs('./2days', exist_ok=True)

df_adm = pd.read_csv('/mnt/nvme4/Datasets/MIMIC-III/physionet.org/files/mimiciii/1.4/ADMISSIONS.csv')
...
df_notes = pd.read_csv('/mnt/nvme4/Datasets/MIMIC-III/physionet.org/files/mimiciii/1.4/NOTEEVENTS.csv')
