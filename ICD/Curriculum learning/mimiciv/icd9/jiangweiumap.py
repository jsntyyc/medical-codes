...
plt.title("UMAP Visualization of RoBERTa Embeddings(MIMICIV-ICD9)", fontsize=16)
...
# 图形美化
plt.title("KMeans Clustering of RoBERTa Embeddings (UMAP)(MIMICIV-ICD9)", fontsize=22)
