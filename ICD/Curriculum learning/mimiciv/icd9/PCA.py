...
# ---------------- 读取数据 ----------------
input_path = "/mnt/nvme2/yyc/medical-coding/files/data/mimiciv_icd10/mimiciv_icd10.feather"
...
# ---------------- 保存带标签的数据 ----------------
output_path = "/mnt/nvme2/yyc/medical-coding/files/data/mimiciv_icd10/mimiciv_icd10_clusters3V2.feather"
