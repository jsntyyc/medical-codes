...
# 设置 GPU 设备
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1,2,3,4,5,6,7"  # 指定使用 GPU:0,1,2,3
...
plt.title("KMeans Clustering of RoBERTa Embeddings (t-SNE)(MIMICIV-ICD9)", fontsize=22)
...
# 绘制聚类中心点
plt.scatter(cluster_centers_tsne[:, 0], cluster_centers_tsne[:, 1], c="red", marker="x", s=100, label="Centroids")
