...
# 读取文件
df = pd.read_feather("/mnt/nvme2/yyc/medical-coding/files/data/mimiciii_full/mimiciii_full.feather")
...
plt.title("UMAP Visualization of RoBERTa Embeddings", fontsize=16)
...
# 绘制聚类中心点
cluster_centers_umap = umap_reducer.transform(kmeans.cluster_centers_)  # 将高维中心投影到 UMAP
plt.scatter(cluster_centers_umap[:, 0], cluster_centers_umap[:, 1], c="red", marker="x", s=100, label="Centroids")

# 图形美化
plt.title("KMeans Clustering of RoBERTa Embeddings (UMAP)", fontsize=22)
...
# output_path = "/mnt/nvme2/yyc/medical-coding/files/data/mimiciii_50/mimiciii_50_umap_clusters3.feather"
